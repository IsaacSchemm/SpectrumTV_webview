...
- New app namespace
- Show the top navbar and player controls
    - Full screen, volume controls, "Guide" option, and seek bar are still hidden
- Arrow buttons are now used to navigate the site
